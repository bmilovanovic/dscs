...
abstract public class Job {
     ...
     */
    abstract public String getAzureUrl();
     ...
     */
    abstract public Storable parseTask(Context context, int key);
     ...
     * @param context Context for networking.
     */
    abstract public void init(Context context) throws ExecutionException, InterruptedException;
}
